...
const Dashboard = () => {
  ...
  return (
    <Layout>
      <section className="hero luxury-hero reveal">
        <div className="hero-inner luxury-inner">
          ...
          <div className="luxury-left">
            ...
            {/* 👇 Avatar Added */}
            <div className="luxury-identity">

              <img
                src="https://i.pravatar.cc/150?img=12"
                alt="CA Chandu K Yadav"
                className="avatar-photo"
              />

              <div className="identity-text">
                <h1>Chandu K Yadav</h1>
              </div>

            </div>

            <p className="luxury-tagline">
              Tax • GST • Compliance • Advisory
            </p>

            <p className="luxury-description">
              Providing reliable tax, GST, and compliance services with accuracy,
              confidentiality, and professional care.
            </p>

            <div className="luxury-actions">
              <button onClick={() => navigate('/compliservices')} className="primary-btn">
                Explore Services
              </button>
            </div>
          </div>
      ...
      <section className="why-choose-section reveal">
        <h2 className="why-choose-title">Why Choose Chandu K Yadav</h2>
      ...
      <section className="reviews reveal">
        ...
        <div className="reviews-layout">
          <div className="reviews-left">
            <h3>
              <span>Chandu k yadav</span> is trusted by founders to start, manage
      ...
      <section className="google-reviews-section">
        <h2 className="reviews-heading">
          Chandu k yadav – Trusted by Indian Entrepreneurs
        </h2>
