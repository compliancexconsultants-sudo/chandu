const llpRegistrationData = {
  hero: {
    ...
    subtitle: "Simplified Guide by Chandu K Yadav",
    description:
      "Launch your LLP easily and professionally with Chandu K Yadav. From Digital Signatures to LLP Agreement drafting, PAN/TAN, and bank account setup — we manage the entire process online so you can focus on your business, not paperwork.",
  },
  ...
  whyChooseIntro:
    "Chandu K Yadav offers a hassle-free, 100% online LLP registration service, ensuring every legal requirement is handled accurately and efficiently.",
