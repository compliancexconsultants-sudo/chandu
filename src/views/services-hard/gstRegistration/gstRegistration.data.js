const gstRegistrationData = {
  ...
  /* ================= META ================= */
  meta: {
    title: "GST Registration & GST 2.0 Guide for Businesses | Chandu K Yadav",
    description:
      "Complete GST registration guide for Indian businesses including GST 2.0 updates. Learn eligibility, documents, process, penalties, benefits & Chandu K Yadav assistance.",
  },
  ...
  hero: {
    ...
    description:
      "Everything your business needs to know about GST registration in India — including the GST 2.0 (Sept 2025) update — explained simply by Chandu K Yadav.",
  },
  ...
  cta: {
    ...
    subtitle:
      "Chandu K Yadav helps you register, file returns, reconcile ITC & stay 100% compliant without penalties.",
  },
};
