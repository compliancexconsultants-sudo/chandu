const esiRegistrationData = {
  ...
  /* ================= META ================= */
  meta: {
    title: "ESI Registration — Employee Health & Social Security | Chandu K Yadav",
    description:
      "Get ESIC registration quickly and compliantly with Chandu K Yadav. Complete guidance on eligibility, documents, process, contribution rates, penalties & compliance support.",
  },
  ...
  hero: {
    ...
    description:
      "Chandu K Yadav helps employers register under the ESIC scheme, comply with labour laws, and manage contributions & returns — protecting your workforce while avoiding penalties.",
  },
  ...
  cta: {
    ...
    subtitle:
      "Chandu K Yadav helps you register your establishment, onboard employees, file contributions & stay labour law compliant.",
  },
};
