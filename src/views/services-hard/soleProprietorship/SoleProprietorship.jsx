  ...
  return (
    <Layout>
      <div className="svc-root">
        ...
        {/* BANK ACCOUNT */}
        <Section title="Bank Account Setup (Chandu K Yadav Assistance)">
          <div className="doc-grid">
        ...
        <section className="trust-band">
          <h2 className="reveal">Why Choose Chandu K Yadav?</h2>
        ...
        <section className="final-cta reveal">
          <h2>Launch Your Business with Chandu K Yadav</h2>
          <p>
